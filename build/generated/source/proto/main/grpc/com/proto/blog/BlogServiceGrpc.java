...
public final class BlogServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.proto.blog.ListBlogRequest,
      com.proto.blog.ListBlogResponse> getListAllBlogsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ListAllBlogs",
  ...
  public static io.grpc.MethodDescriptor<com.proto.blog.ListBlogRequest,
      com.proto.blog.ListBlogResponse> getListAllBlogsMethod() {
    io.grpc.MethodDescriptor<com.proto.blog.ListBlogRequest, com.proto.blog.ListBlogResponse> getListAllBlogsMethod;
    if ((getListAllBlogsMethod = BlogServiceGrpc.getListAllBlogsMethod) == null) {
      synchronized (BlogServiceGrpc.class) {
        if ((getListAllBlogsMethod = BlogServiceGrpc.getListAllBlogsMethod) == null) {
          BlogServiceGrpc.getListAllBlogsMethod = getListAllBlogsMethod = 
              io.grpc.MethodDescriptor.<com.proto.blog.ListBlogRequest, com.proto.blog.ListBlogResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "blog.BlogService", "ListAllBlogs"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.proto.blog.ListBlogRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.proto.blog.ListBlogResponse.getDefaultInstance()))
                  .setSchemaDescriptor(new BlogServiceMethodDescriptorSupplier("ListAllBlogs"))
                  .build();
          }
        }
     }
     return getListAllBlogsMethod;
  }
  ...
  public static abstract class BlogServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void listAllBlogs(com.proto.blog.ListBlogRequest request,
        io.grpc.stub.StreamObserver<com.proto.blog.ListBlogResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getListAllBlogsMethod(), responseObserver);
    }
  ...
  public static final class BlogServiceStub extends io.grpc.stub.AbstractStub<BlogServiceStub> {
    ...
    public void listAllBlogs(com.proto.blog.ListBlogRequest request,
        io.grpc.stub.StreamObserver<com.proto.blog.ListBlogResponse> responseObserver) {
      asyncServerStreamingCall(
          getChannel().newCall(getListAllBlogsMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class BlogServiceBlockingStub extends io.grpc.stub.AbstractStub<BlogServiceBlockingStub> {
     ...
     * </pre>
     */
    public java.util.Iterator<com.proto.blog.ListBlogResponse> listAllBlogs(
        com.proto.blog.ListBlogRequest request) {
      return blockingServerStreamingCall(
          getChannel(), getListAllBlogsMethod(), getCallOptions(), request);
    }
  }
  ...
  private static final int METHODID_LIST_ALL_BLOGS = 4;
      ...
      switch (methodId) {
        ...
        case METHODID_DELETE_BLOG:
          serviceImpl.deleteBlog((com.proto.blog.DeleteBlogRequest) request,
              (io.grpc.stub.StreamObserver<com.proto.blog.DeleteBlogResponse>) responseObserver);
          break;
        case METHODID_LIST_ALL_BLOGS:
          serviceImpl.listAllBlogs((com.proto.blog.ListBlogRequest) request,
              (io.grpc.stub.StreamObserver<com.proto.blog.ListBlogResponse>) responseObserver);
          break;
        default:
      ...
      synchronized (BlogServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getListAllBlogsMethod())
              .build();
        }
      }
    }
