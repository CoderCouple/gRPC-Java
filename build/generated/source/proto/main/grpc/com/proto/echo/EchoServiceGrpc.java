...
@javax.annotation.Generated(
    ...
    comments = "Source: echo/echo.proto")
public final class EchoServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.proto.echo.EchoMessage,
      com.proto.echo.EchoMessage> getEchoMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Echo",
      requestType = com.proto.echo.EchoMessage.class,
      responseType = com.proto.echo.EchoMessage.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.proto.echo.EchoMessage,
      com.proto.echo.EchoMessage> getEchoMethod() {
    io.grpc.MethodDescriptor<com.proto.echo.EchoMessage, com.proto.echo.EchoMessage> getEchoMethod;
      ...
      synchronized (EchoServiceGrpc.class) {
        if ((getEchoMethod = EchoServiceGrpc.getEchoMethod) == null) {
          EchoServiceGrpc.getEchoMethod = getEchoMethod = 
              io.grpc.MethodDescriptor.<com.proto.echo.EchoMessage, com.proto.echo.EchoMessage>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "echo.EchoService", "Echo"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.proto.echo.EchoMessage.getDefaultInstance()))
  ...
  public static abstract class EchoServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void echo(com.proto.echo.EchoMessage request,
        io.grpc.stub.StreamObserver<com.proto.echo.EchoMessage> responseObserver) {
  ...
  public static final class EchoServiceBlockingStub extends io.grpc.stub.AbstractStub<EchoServiceBlockingStub> {
    ...
    /**
     */
    public com.proto.echo.EchoMessage echo(com.proto.echo.EchoMessage request) {
  ...
  public static final class EchoServiceFutureStub extends io.grpc.stub.AbstractStub<EchoServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.proto.echo.EchoMessage> echo(
        com.proto.echo.EchoMessage request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ECHO:
          serviceImpl.echo((com.proto.echo.EchoMessage) request,
              (io.grpc.stub.StreamObserver<com.proto.echo.EchoMessage>) responseObserver);
          break;
        default:
  ...
  private static abstract class EchoServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.proto.echo.Echo.getDescriptor();
    }
